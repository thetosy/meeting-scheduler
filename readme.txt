...
serverM.cpp - receives list of usernames contained in serverA and serverB. Also facilitates communication between client and backend servers by getting usernames from the client and sending the request to the needed servers and sending the final availiabity time to the client
